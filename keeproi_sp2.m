...
if(manual_roi_sp2==1)
    p1 = [roi_xmin_sp2 roi_zmin_sp2];
    p2 = [roi_xmax_sp2 roi_zmax_sp2];
    offset = abs(p1 - p2); 
...
if handles.fr_pressed_sp2 == 1
    ...
    Anew = A(ax_sp2(3):ax_sp2(4),ax_sp2(1):ax_sp2(2));  % ax_sp2 defines the ROI
...
keepROI_option_sp2 = 1; % for data plotter storage
